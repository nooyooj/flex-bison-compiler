...
{
  "$end", "error", "$undefined", "NUMBER", "ID", "PROGRAM", "VAR",
  "ARRAY", "OF", "INTEGER", "REAL", "BGN", "END", "IF", "THEN", "ELSE",
  "WHILE", "DO", "DOTS", "PRINT", "STD_TYPE", "CMP", "'='", "'+'", "'-'",
  "'*'", "'/'", "'|'", "UMINUS", "'('", "')'", "';'", "'.'", "':'", "'['",
  "']'", "'{'", "'}'", "','", "$accept", "program", "decl_list",
  "declaration", "stmt", "stmt_list", "exp", "numList", "symbolList", YY_NULLPTR
};
#endif
...
#line 43 "grammar.y" /* yacc.c:1646  */
    { (yyval.a) = newDeclaration((yyvsp[-2].symbolList), (yyvsp[0].type_c)); }
#line 1313 "grammar.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 45 "grammar.y" /* yacc.c:1646  */
    { (yyval.a) = newDeclarationArr((yyvsp[-9].symbolList), (yyvsp[-5].d), (yyvsp[-3].d), (yyvsp[0].type_c)); }
...
#line 69 "grammar.y" /* yacc.c:1646  */
    { (yyval.a) = newAssignArr((yyvsp[-5].s), (yyvsp[-3].a), (yyvsp[0].a)); }
...
#line 71 "grammar.y" /* yacc.c:1646  */
    { (yyval.a) = newInitialArr((yyvsp[-4].s), (yyvsp[-1].numList)); }
...
#line 79 "grammar.y" /* yacc.c:1646  */
    { (yyval.symbolList) = newSymbolList((yyvsp[0].s), NULL); }
#line 1457 "grammar.tab.c" /* yacc.c:1646  */
    break;

  case 31:
#line 80 "grammar.y" /* yacc.c:1646  */
    { (yyval.symbolList) = newSymbolList((yyvsp[-2].s), (yyvsp[0].symbolList)); }
